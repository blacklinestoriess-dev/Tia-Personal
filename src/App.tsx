      ...
      .then((data) => {
        if (data?.user && data?.profile) {
          ...
          const mappedOwner: OwnerProfile = {
            ...
            relationship: 'owner',
            location: data.profile.address || 'Patna, India',
            occupation_status: data.profile.occupation_status || 'working on a startup',
  ...
  const handleLoginSuccess = useCallback(
    (session: AuthSession) => {
      ...
      const mappedOwner: OwnerProfile = {
        ...
        relationship: 'owner',
        location: session.profile.address || 'Patna, India',
        occupation_status: session.profile.occupation_status || 'working on a startup',
        personality_traits: ['intelligent', 'curious', 'ambitious'],
        additional_memories: [],
        last_updated: new Date().toISOString(),
      };
